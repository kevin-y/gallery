...
public class User implements Serializable {
	...
	@Column(name = "email_verification_code", nullable = false, length = 8)
	private String verificationCode;
	@Column(name = "vcode_expires_in", nullable = false)
	private Timestamp vcodeExpiresIn;
	...
	public Timestamp getVcodeExpiresIn() {
		return vcodeExpiresIn;
	}

	public void setVcodeExpiresIn(Timestamp vcodeExpiresIn) {
		this.vcodeExpiresIn = vcodeExpiresIn;
	}
